...
public class PiCalcTest {
    ...
    @Test
    public void deberiaFuncionarConUnHilo() throws Exception {
        ...
        for (int start = 0; start < expected.length; start++) {
            for (int count = 1000; count < expected.length - start; count++) {
    ...
    @Test
    public void deberiaFucionarConDosHilos() throws Exception {
    ...
    @Test
    public void deberiaFuncionarConTresHilos() throws Exception {
    ...
    @Test
    public void deberiaFuncionarConCienHilos() throws Exception {
        ...
        for (int start = 0; start < expected.length; start++) {
            for (int count = 1000; count < expected.length - start; count++) {
                byte[] digits = PiDigits.getDigits(start, count,100);
                assertEquals(count, digits.length);
